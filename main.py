...
parser.add_argument('--d_embeds', type=int, default=4, help='dimension of laplacian features')
...
parser.add_argument('--embed_features', type=int, default=16, help='dimensions of graph embedding')
